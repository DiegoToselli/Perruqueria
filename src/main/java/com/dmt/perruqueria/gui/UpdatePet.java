...
public class UpdatePet extends javax.swing.JFrame {
    ...
    public UpdatePet(int num_client_pet) {
        controller = new Controller();

        initComponents();
        setIcon();

        loadPetData(num_client_pet);
    }
    ...
    private void initComponents() {
        ...
        lblTitle.setText("Modificar Mascota");
            ...
            .addGroup(panelDataContainerLayout.createSequentialGroup()
                ...
                .addGroup(panelDataContainerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelDataContainerLayout.createSequentialGroup()
                        .addGroup(panelDataContainerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(panelDataContainerLayout.createSequentialGroup()
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, panelDataContainerLayout.createSequentialGroup()
                            ...
                            .addGroup(panelDataContainerLayout.createSequentialGroup()
                                ...
                                .addGroup(panelDataContainerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelDataContainerLayout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(txtPetName, javax.swing.GroupLayout.PREFERRED_SIZE, 260, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                        .addGap(26, 26, 26))
                    .addGroup(panelDataContainerLayout.createSequentialGroup()
                        .addGroup(panelDataContainerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(panelDataContainerLayout.createSequentialGroup()
        ...
        btnUpdatePet.setForeground(new java.awt.Color(0, 0, 0));
        btnUpdatePet.setFont(new java.awt.Font("Verdana", 0, 12)); // NOI18N

        lblButtonUpdatePet.setBackground(new java.awt.Color(251, 237, 236));
        lblButtonUpdatePet.setFont(new java.awt.Font("Verdana", 0, 12)); // NOI18N
        lblButtonUpdatePet.setForeground(new java.awt.Color(0, 0, 0));
        ...
        lblButtonUpdatePet.setText("  Guardar Cambios");
        ...
        btnUpdatePetLayout.setHorizontalGroup(
            ...
            .addComponent(lblButtonUpdatePet, javax.swing.GroupLayout.DEFAULT_SIZE, 248, Short.MAX_VALUE)
        );
        ...
        bg.add(btnUpdatePet, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 428, 250, 36));
    ...
    private void lblButtonUpdatePetMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblButtonUpdatePetMouseClicked
        ...
        if (!isEmptyInputs()) {
            controller.updatePet(pet, petName, petRace, petColor, petAllergi, petParticularAttn, ownerName, ownerContact);

            clearInputs();
            showMessage("Los datos han sido cargado con éxito en nuestra base de datos.", "Info", "Modificar - Éxito");
            ...
            showMessage("Existen campos vacio, todos los campos son obligatorios", "Error", "Modificar - Error");
        }
    ...
    private void loadPetData(int num_client_pet) {
        this.pet = controller.findPet(num_client_pet);

        txtPetName.setText(pet.getPetName());
        txtPetRace.setText(pet.getPetRace());
        txtPetColor.setText(pet.getPetColor());
        txtOwnerName.setText(pet.getPetOwner().getOwnerName());
        txtOwnerContact.setText(pet.getPetOwner().getOwnerContact());

        if (pet.getPetAllergi().equalsIgnoreCase("Si")) {
            cmbPetAllergi.setSelectedIndex(1);
        } else {
            if (pet.getPetAllergi().equalsIgnoreCase("No")) {
                cmbPetAllergi.setSelectedIndex(2);
            }
        }

        if (pet.getPetParticularAttn().equalsIgnoreCase("Si")) {
            cmbPetParticularAttn.setSelectedIndex(1);
        } else {
            if (pet.getPetParticularAttn().equalsIgnoreCase("No")) {
                cmbPetParticularAttn.setSelectedIndex(2);
            }
        }
    }
